    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="container__main">
                ...
                <p class="container__header">Номер класса "Стандарт"</p>
                <div class="container__images images">
                    <div class="images__left">
                        <img src="../img/img_rooms/standart/7d91a65a1cd28a3f9a484fc28bc53f50.jpg" class="images__1">
                        <img src="../img/img_rooms/standart/30409b0caf5d875a34c2ef0eb8948a0e.jpg" class="images__2">
                    </div>
                    <div class="images__right">
                        <img src="../img/img_rooms/standart/03a6b8613c70b144abd844ab418b4e48.jpg" class="images__3">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container4__main">
                <div class="why__review review" id="review_1">
                    ...
                    <div class="review__text">
                        ...
                        <p class="review__review">Снимал номер для отдыха с детьми, все на высшем уровне</p>
                    </div>
                </div>

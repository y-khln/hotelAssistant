...
<html lang="ru">
    <head>
        ...
        <link rel="stylesheet" href="../css/style_room_separate.css">
    </head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="container__main">
                ...
                <p class="container__header">Номер класса "Стандарт раздельный"</p>
                <div class="container__images images">
                    <div class="images__left">
                        <img src="../img/img_rooms/separate/2fafc977bc5b28e0aedd722ddae07ae0.jpg" class="images__1">
                        <img src="../img/img_rooms/separate/f0cce2818dc9acafc265362c8f0434ff.jpg" class="images__2">
                    </div>
                    <div class="images__right">
                        <img src="../img/img_rooms/separate/separate_main.jpg" class="images__3">
                    </div>
                </div>
                <div class="images__bottom">
                    <img src="../img/img_rooms/separate/d19ee14557d1b19f7fc86f6cb1b6eb69.jpg" class="images__4">
                    <img src="../img/img_rooms/separate/9e4d17d6311b62cc4ef5c5a13c287597.jpg" class="images__5">
                </div>
            </div>
        </div>
